				...
				<form action="payment_form.php" method="POST">
					<div class="row">
						...
						<!-- 	<div class="contact-fields-w3ls">
							...
							<div class="contact-fields-w3ls">
								<input type="text" name="Amount" placeholder="Amount" value="5000" required="" disabled="disabled">
							</div>
							<div class="contact-fields-w3ls">
...
$status = ($row_imp) ? $row_imp['Status'] : 0;
...
if ($status == 0) {
    ...
    if ($row = mysqli_fetch_assoc($result)) {
        ...
        if (!$pwdCheck) {
            ...
            $query3 = "INSERT INTO Payment (Student_id, Status, Amount) VALUES ('$roll', 1, 75000)";
    ...
    echo "<script>alert('You have already paid the fees')</script>";
}
