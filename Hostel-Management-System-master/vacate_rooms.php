				...
				<form action="vacate_rooms.php" method="post">
					<div class="row">
						<div class="col-md-6 contact_left_grid" data-aos="fade-right">
							...
							<div class="contact-fields-w3ls">
								<input type="text" name="hostel" placeholder="Hostel" value="<?php echo $hostel_name;?>" required="">
							</div>
							<div class="contact-fields-w3ls">
...
if(isset($_POST['submit'])){
    ...
    // Instead of strict Room_id check, you can check Hostel_id + Student_id only:
	$query3 = "SELECT * FROM Student WHERE Student_id = '$roll' AND Hostel_id = '$hostel_id'";
    $result3 = mysqli_query($conn,$query3);
    if(mysqli_num_rows($result3) == 0){
        echo "<script>alert('Incorrect Details: Student not in this room')</script>";
        exit();
    }
