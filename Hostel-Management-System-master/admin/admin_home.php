...
if (!isset($_SESSION['username'])) {
    header("Location: http://localhost/Hostel-Management-System-master/login-hostel_manager.php"); // redirect to login page
    exit();
}
?>
<!DOCTYPE html>
...
<header>
	<div class="container agile-banner_nav">
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			...
			<h1><a class="navbar-brand" href="admin_home.php">SUSL <span class="display"></span></a></h1>
				...
				<ul class="navbar-nav ml-auto">
					...
					<li class="dropdown nav-item">
						<a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
							<?php 
							// Changed syntax: safely check session variable
							if (isset($_SESSION['username'])) {
				...
				<li class="next-slide">
					<div class="svg-wrapper">
						<svg viewBox="0 0 1400 800">
							...
							<image width="1400px" clip-path="url(#cd-image-2)" xlink:href="../web_home/images/2.jpg"></image>
						</svg>
					</div> <!-- .svg-wrapper -->
				...
				<li>
					<div class="svg-wrapper">
						<svg viewBox="0 0 1400 800">
							...
							<image  width="1400px" clip-path="url(#cd-image-3)" xlink:href="../web_home/images/3.jpg"></image>
						</svg>
					</div> <!-- .svg-wrapper -->
					<div class="cd-radial-slider-content text-center">
						<div class="wrapper">
