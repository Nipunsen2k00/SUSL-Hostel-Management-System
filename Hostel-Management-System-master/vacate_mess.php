...
$mess_id_student = $row_student['Mess_id'];
$mess_card_id_student = $row_student['Mess_card_id'];

if(is_null($mess_id_student) || is_null($mess_card_id_student)){
    echo "<script>alert('Mess not allocated for this student')</script>";
    exit();
}

if($mess_card_number != $mess_card_id_student){
    echo "<script>alert('Mess Card Number mismatch')</script>";
    exit();
}
...
if($result4){
    $query5 = "UPDATE Mess_Allocation SET Allocated = 0 WHERE Mess_card_id = '$mess_card_id_student'";
...
<footer class="py-5">
	<div class="container py-md-5">
		<div class="footer-logo mb-5 text-center">
			<a class="navbar-brand" href="index.html">SUSL<span class="display"></span></a>
		</div>
