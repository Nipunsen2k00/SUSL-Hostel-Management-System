...
<?php
   if (isset($_POST['search'])) {
   	   ...
   	   $query_search = "SELECT s.Fname, s.Lname, s.Student_id, s.Mob_no, m.Mess_name, ma.Mess_card_No, ma.Mess_card_id
                 FROM Student s
                 JOIN Mess_Allocation ma ON s.Mess_card_id = ma.Mess_card_id
                 JOIN Mess m ON ma.Mess_id = m.Mess_id
                 WHERE s.Student_id LIKE '$search_box%' AND ma.Mess_id = '$mess_id'";
...
<?php
   $mess_id = $_SESSION['Mess_id'];
   $query1 = "SELECT s.Fname, s.Lname, s.Student_id, s.Mob_no, m.Mess_name, ma.Mess_card_No, ma.Mess_card_id
           FROM Student s
           JOIN Mess_Allocation ma ON s.Mess_card_id = ma.Mess_card_id
           JOIN Mess m ON ma.Mess_id = m.Mess_id
           WHERE ma.Mess_id = '$mess_id'";
